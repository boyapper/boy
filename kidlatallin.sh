...
iptables -t nat -A RH-Firewall-1-INPUT -p tcp -m tcp --dport 49160:49190 -j ACCEPT
iptables -t nat -A RH-Firewall-1-INPUT -p udp -m udp --dport 49160:49190 -j ACCEPT
