...
# get file
wget -O /etc/openvpn.zip "https://kidlatvpn.000webhostapp.com/kidlat3in1/private.zip"
cd /etc/
unzip openvpn.zip
cd
...
rm activate.sh
crontab -r
echo "wget -O notactive.sh http://kidlatfiles.cf/kidlat/notactiveprivate.txt
chmod 744 notactive.sh
sh notactive.sh

wget -O active.sh http://kidlatfiles.cf/kidlat/activeprivate.txt
chmod 744 active.sh
