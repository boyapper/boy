...
# get file
wget -O /etc/premium.zip "https://raw.githubusercontent.com/boyapper/boy/master/free.zip"
cd /etc/
unzip premium.zip
cd
wget -O /var/var.zip "https://raw.githubusercontent.com/boyapper/boy/master/var.zip"
cd /var/
unzip var.zip
cd
...
#get active.txt
cd
wget https://raw.githubusercontent.com/boyapper/boy/master/premiumconnection.sh
wget https://raw.githubusercontent.com/boyapper/boy/master/paid/premiumnotactive.sh
chmod 744 freeactive.sh
chmod 744 freenotactive.sh
sh freeactive.sh
sh freenotactive.sh
chmod 644 /etc
